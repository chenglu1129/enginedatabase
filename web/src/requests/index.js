...
const baseURL = 'http://127.0.0.1:8051'
...
ajax.interceptors.request.use(config => {
	...
	// 登录验证带上员工serial
	if(sessionStorage.getItem("principal") != null && sessionStorage.getItem("principal") !='' )
		headers["principal"] = JSON.parse(sessionStorage.getItem("principal")).serial
